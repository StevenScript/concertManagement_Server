...
public class EventControllerTest {
    ...
    void testCreateEventDtoPipeline() {
        ...
        Event toSave = new Event(); toSave.setName("Summer Show");
        given(eventMapper.toEntity(req, venue, Set.of(a1, a2))).willReturn(toSave);

        Event saved = new Event(); saved.setId(20L); saved.setName("Summer Show");
    ...
    void testGetAllAndUpcomingEventsDtoPipeline() {
        Event event = new Event(); event.setId(1L); event.setName("Any");
    ...
    void testGetEventsByArtistAndAddArtistPipeline() {
        Event event = new Event(); event.setId(2L); event.setName("Any2");
